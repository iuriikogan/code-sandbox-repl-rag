...
const (
	PriceProInputPer1M   = 3.50  // gemini-3.1-pro approx input cost
	PriceFlashInputPer1M = 0.075 // gemini-3.1-flash approx input cost
...
func getModelPrice(modelName string) float64 {
	...
	case "gemini-3.1-flash", "gemini-3.1-flash-lite", "gemini-1.5-flash":
